...
- **May basis guard:** retained revisions **12221 and 12438** and the current uncached read all yield 313,516 kg primary output + 30,484 kg rejection = **344,000 kg gross**. No retained revision yields 343,879 kg; that figure mixes corrected output with the retired 30,363 kg rejection. Finishing contributes 116,200 kg, so the freeze's reconciled, finishing-inclusive logical capture is **429,716 kg**.
