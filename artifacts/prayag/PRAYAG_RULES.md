...
- The former eight-value hours handover (**1,982 / 855 / 1,117 / 863 / 1,107 / 22 / 0 / 561**) implicitly paired M/C-1+M/C-2 and was unsourced when stated. It is superseded by the nine-machine recompute above. The full **+10 h** is now revision-traced: May M/C-5 **+6** (12374→12438); June M/C-5 **+3**, M/C-6 **+19**, M/C-7 **−22** (11780→11932, net 0); July M/C-2 **−11**, M/C-3 **+15** (13165→13247, net +4); April unchanged (10768→10806). Therefore **6,517 h is final, not provisional**.
- **May basis guard:** Report-5 May gross **344,000 kg = 313,516 kg output + 30,484 kg rejection**, independently summed from the 115 current primary machine-day records on 11 September. Retained revisions **11932, 12221, and 12438** all produce the same 344,000 kg. No retained revision yields 343,879 kg; it is 344,000 − 121, a double-subtraction. Adding 121 back while holding the post-correction rejection fixed gives a hypothetical 344,121 kg, but that is also not an observed retained revision. Finishing contributes 116,200 kg, so the frozen finishing-inclusive capture is **429,716 kg**; 429,595 is retired with 343,879.
- The management fixture audit removed the retired constants **1,277,974.20 / 1,283,300.15 / 6,507**. Its `PIPE_APR_JUL_*` constants are derived from the current accepted sources and must move whenever that accepted total moves. The former 1,277,974.20 Report-5 fixture differed by an unexplained **3.20 kg** from the retired Part 4 Report-5 total of 1,277,971; neither old figure is a current golden value.
...
### Failure Mode #20 — A derived residual can masquerade as a verified month

**Symptom:** a monthly figure is calculated as a multi-month total minus the
other known months, then later treated as though that month was directly parsed,
observed or independently accepted.

**Rule:** a residual derived by subtraction absorbs every upstream error into
the last unknown. Never treat a derived monthly figure as a verified benchmark.
Label it as derived, retain the complete subtraction chain, and require direct
