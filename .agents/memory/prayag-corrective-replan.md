...
1. ≥ MIN_DAYS_FOR_P90 (=5) non-zero days → p90 (10th-percentile, conservative 90%-confidence floor)
...
## produced-to-date fix (Fix 4 — TEFFLONE)
...
## Test suite
63 regression tests covering: relabelling, not-started, low-confidence flag, produced-to-date reconciliation, TEFFLONE, XLSX label assertions, cap_feasible column optional/populated.
